...
public class TrainingScript : MonoBehaviour {
	...
	private IEnumerator _StartTraining()
	{
		...
		BaseItemScript newUnit = Scenman.instance.AddItem(_currentTrainingTroop, -1, (int)randomFrontCell.x, (int)randomFrontCell.z, true, true);
		BaseItemScript nearestArmyCamp = Scenman.instance.GetNearestArmyCamp(newUnit.GetPosition());

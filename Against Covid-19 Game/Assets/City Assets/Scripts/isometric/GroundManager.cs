...
public class GroundManager : MonoBehaviour {
	...
	public void UpdateAllNodes(){
		...
		foreach (KeyValuePair<int, BaseItemScript> entry in Scenman.instance.GetItemInstances()) {
...
//			}
	...
	public BaseItemScript GetItemInPosition(Vector3 position){
		...
		Scenman.instance.GetItemInstances ().TryGetValue (itemInstanceId, out item);
		return item;
	}

...
public class ItemOptionsWindowScript : WindowScript {
	...
	{
		BaseItemScript selectedItem = Scenman.instance.selectedItem;
	...
	public void OnClickRemoveButton()
	{
		...
		DataBaseManager.instance.RemoveItem(Scenman.instance.selectedItem);
		Scenman.instance.RemoveItem(Scenman.instance.selectedItem);
	}
